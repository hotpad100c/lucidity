...
public class WandTooltipRenderer {
    ...
    public static void renderWandModeIcon(DrawContext context) {
        ...
        RenderSystem.enableBlend();
        context.drawTexture(secondIcon, x , y + iconWidth, 0, 0, iconWidth, iconWidth, iconWidth, iconWidth);
        RenderSystem.disableBlend();
        context.drawText(client.textRenderer, Text.translatable(translationKey), x+iconWidth, y + iconWidth+ (iconWidth/2), 0xFFFFFFE0, true);
